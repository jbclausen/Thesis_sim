...
namespace dolfin
{
  class dolfin_expression_f6219177805604588876d025ac628423 : public Expression
  {
     public:
...
std::shared_ptr<dolfin::GenericFunction> generic_function_p2;
       ...
       dolfin_expression_f6219177805604588876d025ac628423()
       {
       ...
       void eval(Eigen::Ref<Eigen::VectorXd> values, Eigen::Ref<const Eigen::VectorXd> x) const override
       {
          ...
          values[0] = x[1] <  0.00266 + DOLFIN_EPS ? p1 : 0);
...
extern "C" DLL_EXPORT dolfin::Expression * create_dolfin_expression_f6219177805604588876d025ac628423()
{
  return new dolfin::dolfin_expression_f6219177805604588876d025ac628423;
}
